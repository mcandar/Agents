...
Raw_SaleData <- Format.SaleData(read.table("Month7.txt",sep=",",colClasses = "character")) # for month11, as seen.
print("Sale data is imported")

print("I start Match.ShipData() function.\n")
matched_m7 <- Match.ShipData(Shipping_Filtered,month = 7,Raw_SaleData,filename = "Most_Expensive_Matched_M7_test_",begin = 9)