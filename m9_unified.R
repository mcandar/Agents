...
Raw_SaleData <- Format.SaleData(read.table("Month9.txt",sep=",",colClasses = "character")) # for month11, as seen.
print("Sale data is imported")

print("I start Match.ShipData() function.\n")
matched_m9 <- Match.ShipData(Shipping_Filtered,month = 9,Raw_SaleData,filename = "Most_Expensive_Matched_M9_test_")