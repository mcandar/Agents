...
current_item <- as.character(read.csv("/home/candar/Data_Final/final_summary.csv",row.names = NULL)[1,1])
print(current_item)
file_name <- "Q3_OC_TOP_FINALDATA_TEST" # name of the final output file and temporary files
output <- data.frame() # final output

# from months 10 to 12
for(i in 10:12){
